...
SRCS =  ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_memset.c ft_strlen.c \
		...
		ft_memchr.c ft_strchr.c ft_strrchr.c ft_strnstr.c ft_strlcat.c ft_strlcpy.c ft_strdup.c ft_substr.c ft_strjoin.c\
		ft_strtrim.c ft_calloc.c ft_strmapi.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_striteri.c\
		ft_itoa.c ft_split.c ft_putnbr_fd.c
